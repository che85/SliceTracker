...
from ProstateCryoAblationUtils.appConfig import SliceTrackerConfiguration
from ProstateCryoAblationUtils.constants import SliceTrackerConstants
from ProstateCryoAblationUtils.session import SliceTrackerSession

from ProstateCryoAblationUtils.steps.base import SliceTrackerStep
from ProstateCryoAblationUtils.steps.intraOperativeTargeting import SliceTrackerOverviewStep
from ProstateCryoAblationUtils.steps.zFrameRegistration import SliceTrackerZFrameRegistrationStep
from ProstateCryoAblationUtils.steps.evaluation import SliceTrackerEvaluationStep
from ProstateCryoAblationUtils.steps.segmentation import SliceTrackerSegmentationStep
...
class SliceTracker(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.helpText = """ ProstateCryoAblation facilitates support of MRI-guided targeted prostate biopsy.
